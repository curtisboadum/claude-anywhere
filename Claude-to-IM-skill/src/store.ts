/**
 * @file store.ts
 * @description JSON file-backed BridgeStore. In-memory Maps with write-through
 *   persistence to ~/.claude-to-im/data/. All state files/dirs are created with
 *   owner-only permissions (0600/0700) — they hold session, binding, audit, and
 *   permission data.
